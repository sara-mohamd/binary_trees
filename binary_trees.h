...
/**
 * struct mskitpg_quaue_s - Queue traversal in level order.
 * @zace: A binary tree node.
 * @usher: The binary tree usher node to travel to.
 */
typedef struct mskitpg_quaue_s
{
binary_tree_t *zace;
struct mskitpg_quaue_s *usher;
} mzbziey_quaue_t;


/* assistance feature for printing */
void binary_tree_print(const
binary_tree_t *);

/* prototypes for the tasks involved */
...
/* Jobs in the Max Binary Heap are prototypes. */
